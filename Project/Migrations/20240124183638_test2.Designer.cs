...
namespace Roads.Migrations
{
    ...
    [Migration("20240124183638_test2")]
    partial class test2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Roads.Models.UserTrackCarRelation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasAlternateKey("IdUser", "IdTrack", "IdCar");

                    b.HasIndex("IdCar");

                    b.HasIndex("IdTrack");

                    b.ToTable("UserTrackCarRelations");
                });
            ...
            modelBuilder.Entity("Roads.Models.UserTrackCarRelation", b =>
                {
                    b.HasOne("Roads.Models.Car", "Car")
                        .WithMany("UserTrackCarRelations")
                        .HasForeignKey("IdCar")
            ...
            modelBuilder.Entity("Roads.Models.Car", b =>
                {
                    b.Navigation("UserTrackCarRelations");
                });
