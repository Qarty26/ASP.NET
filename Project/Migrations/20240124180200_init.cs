        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdTrack = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    FirstCreated = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModified = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserTrackCarRelations", x => x.Id);
                    table.UniqueConstraint("AK_UserTrackCarRelations_IdUser_IdTrack_IdCar", x => new { x.IdUser, x.IdTrack, x.IdCar });
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserTrackCarRelations_Cars_IdCar",
                        column: x => x.IdCar,
                        principalTable: "Cars",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserTrackCarRelations_Tracks_IdTrack",
                        column: x => x.IdTrack,
                        principalTable: "Tracks",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserTrackCarRelations_IdCar",
                table: "UserTrackCarRelations",
                column: "IdCar");

            migrationBuilder.CreateIndex(
                name: "IX_UserTrackCarRelations_IdTrack",
                table: "UserTrackCarRelations",
                column: "IdTrack");
        }
